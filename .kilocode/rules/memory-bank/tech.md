...
- Database configured (Drizzle + SQLite)
...
- `DB_URL` - Database connection string (provided by sandbox)
- `DB_TOKEN` - Database authentication token (provided by sandbox)
- Add additional variables as needed for features
